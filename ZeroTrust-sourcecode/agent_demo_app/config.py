...
DATASET_DIR = Path(os.getenv("MABZT_DATASET_DIR", str(EXPERIMENT_ROOT / "\u5b9e\u9a8c\u6570\u636e\u96c6" / "mabzt_comm_dataset")))
RESULTS_DIR = Path(os.getenv("MABZT_RESULTS_DIR", str(EXPERIMENT_ROOT / "\u5b9e\u9a8c\u7ed3\u679c")))
OTHER_DIR = Path(os.getenv("MABZT_OTHER_DIR", str(EXPERIMENT_ROOT / "\u5176\u4ed6\u6587\u4ef6")))
