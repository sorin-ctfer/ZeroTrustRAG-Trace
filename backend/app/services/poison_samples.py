...
class PoisonSampleService:
    ...
    def create(
        ...
        sample = {
            ...
            "risk_label": "benign_error" if attack_type == "benign_error" else "poison",
            "risk_level": "medium" if attack_type == "benign_error" else "high",
            "risk_score": 0.35 if attack_type == "benign_error" else 0.85,
